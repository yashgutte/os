/*
Question 17: Implement linear probing collision handling technique for hash table
*/
...
// Function to insert a key-value pair using linear probing
...
// Function to delete a key using linear probing
